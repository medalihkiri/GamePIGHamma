...
public class PlacementState : IBuildingState
{
    ...
    public void RotateBuilding(Vector3Int gridPosition)
    {
        ...
        */
        ...
        GameObject pivotPoint = x.GetComponent<GameObject>();
       // x.transform.RotateAround(pivotPoint.transform.localPosition,Vector3.up,90);
    }
    ...
    public void OnAction(Vector3Int gridPosition, Quaternion rotation)
    {
        ...
        Building MyBuilding = x.GetComponent<Building>();
        MyBuilding.positionInGrid = gridPosition;
        Debug.Log("===========================================");
        Debug.Log("x"+ x.GetComponent<Building>().positionInGrid.ToString());
        Debug.Log("position:"+ MyBuilding.positionInGrid.ToString());
        Debug.Log("===========================================");
        int index = objectPlacer.PlaceObject(x,grid.CellToWorld(gridPosition));

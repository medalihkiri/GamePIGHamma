...
namespace Animmal.NotificationSystem
{
    ...
    public class NotificationItem : MonoBehaviour, IDisplayable
    {
        ...
        [Tooltip("Called when item hide instruction is recieved. Use it to define what happens when item must be hidden. Please note: This won't be invoked when item is hidden through display behavior classes like LerpAnimation or Animator display animation.")]

...
namespace Animmal
{
    public class DisplayCanvasGroupBase : DisplayBehaviorBase
    {
        ...
        [Tooltip("Enable to make sure animation can play when time-scale is 0. FE: Game pause scenario")]
        ...
        protected virtual IEnumerator Animation()
        {
            ...
            float _Value = (Mathf.Abs(_ShownAlpha - _HiddenAlpha) / TargetDuration) * (TimescaleIndependant ? Time.unscaledDeltaTime : Time.deltaTime);

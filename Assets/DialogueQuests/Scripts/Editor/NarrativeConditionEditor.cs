...
namespace DialogueQuests.EditorTool
{
    ...
    public class NarrativeConditionEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            if (myScript.type == NarrativeConditionType.CountSObject)
            {
                myScript.value_data = AddScriptableObjectField<IdData>("SObject", myScript.value_data);
                myScript.oper = (NarrativeConditionOperator)AddEnumField("Operator", myScript.oper);
                myScript.value_int = AddIntField("Value", myScript.value_int);
                value_compare = true;
            }
            ...
            if (myScript.type == NarrativeConditionType.HasLevel)
            {
                myScript.target_id = AddTextField("Level Type", myScript.target_id);
                myScript.oper = (NarrativeConditionOperator)AddEnumField("Operator", myScript.oper);
                myScript.value_int = AddIntField("Value", myScript.value_int);
                value_compare = true;
            }

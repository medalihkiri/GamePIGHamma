    ...
    public class NarrativeEffectEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (myScript.type == NarrativeEffectType.Move || myScript.type == NarrativeEffectType.Show || myScript.type == NarrativeEffectType.Hide
                || myScript.type == NarrativeEffectType.Instantiate || myScript.type == NarrativeEffectType.Destroy
            ...
            if (myScript.type == NarrativeEffectType.Move || myScript.type == NarrativeEffectType.Instantiate)
            {
